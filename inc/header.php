...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?= URL; ?>assets/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css">
                                    ...
                                    <div class="header_search_form_container">
                                        <form method="GET" action="<?= URL ?>search.php"
                                            ...
                                            <button type="submit" class="header_search_button trans_300"
                                                value="Submit"><img src="<?= URL; ?>assets/images/search.png"
                                                    alt=""></button>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="main_nav_content d-flex flex-row">
                                ...
                                <div class="cat_menu_container">
                                    ...
                                    <ul class="cat_menu">
                                        ...
                                        <li><a href="category.php?id=<?= $cat['id'] ?>"><?= $cat['name']; ?> <i
                                ...
                                <div class="main_nav_menu ml-auto">
                                    <ul class="standard_dropdown main_nav_dropdown">
                                        ...
                                        <li><a href="<?= URL; ?>products.php">All products<i
